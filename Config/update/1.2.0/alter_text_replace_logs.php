...
class TextReplaceLogsSchema extends CakeSchema {
	...
	public $text_replace_logs = array(
		...
		'search_pattern' => array('type' => 'string', 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '検索語句', 'charset' => 'utf8'),
		'replace_pattern' => array('type' => 'string', 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '置換後', 'charset' => 'utf8'),
		...
		'model' => array('type' => 'string', 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '検索置換時の対象モデル名', 'charset' => 'utf8'),
		...
		'query_url' => array('type' => 'text', 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '検索置換実行時のURL', 'charset' => 'utf8'),
